...
What do vehicle fatality rates look like? To find this, think about vehicles per capita (.831 - found by dividing vehicle registrations by population) (https://www.fhwa.dot.gov/policyinformation/statistics/2018/pdf/mv1.pdf) and per houshold (1.9).'
```{r}
