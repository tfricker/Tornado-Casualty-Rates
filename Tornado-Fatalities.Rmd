...
A = ggplot(dfM, aes(x = yr, y = value, colour = variable)) +
  geom_point() + geom_smooth(method = lm, size = .35) +
  xlab("Year") +
...
C = ggplot(dfM2, aes(x = mo, y = value, colour = variable)) +
  geom_point(data = dfM2[dfM2$variable == "Rfat",], position = position_dodge(0.5)) +
  geom_point(data = dfM2[dfM2$variable == "NRfat",], position = position_dodge(0.5)) +
